...
class Settings(BaseSettings):
    ...
    agent_system_prompt: str = Field(
        default=(
            ...
            "For follow-up questions about papers already shown in the conversation, including phrases like "
            "'compare them' or 'compare these two reviews', use the existing conversation context if it is enough. "
            "If the current context is too limited for a useful comparison, briefly say that more source detail is "
            "needed, retrieve more information with the available tools, and then compare the papers.\n\n"
